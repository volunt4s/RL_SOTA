...
class Env(tk.Tk):
    def __init__(self, render_speed=0.1):
    ...
    def load_images(self):
        rectangle = PhotoImage(
            Image.open("/Users/hong/PycharmProjects/pythonProject/img/rectangle.png").resize((30, 30)))
        triangle = PhotoImage(
            Image.open("/Users/hong/PycharmProjects/pythonProject/img/triangle.png").resize((30, 30)))
        circle = PhotoImage(
            Image.open("/Users/hong/PycharmProjects/pythonProject/img/circle.png").resize((30, 30)))
